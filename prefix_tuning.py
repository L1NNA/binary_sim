...
from models.prefix_sft import PrefixSFT
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model", choices=models.keys(), default='qwen_emb',
        help="The model name"
    )
    parser.add_argument(
    ...
    ########## Load Data ##########
    dataset = BinSimDataset('train', max_num = 100)
    ...
    output_dir = f'./model_checkpoints/PrefixTuning_{args.model}'
